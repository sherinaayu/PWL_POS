    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($row) {
                return '<a href="/PWL_POS/public/stok/edit/' . $row->stok_id . '"class="btn btn-primary ">Edit</a>
                        <a href="/PWL_POS/public/stok/delete/' . $row->stok_id . '"class="btn btn-primary ">Delete</a>';
            })
            ->setRowId('id');
    }
